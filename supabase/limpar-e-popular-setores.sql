-- Script para LIMPAR e REPOPULAR as tabelas de setores e subsetores
-- Execute este script para resetar e popular novamente

-- PASSO 1: Limpar dados existentes
DELETE FROM public.subsetores;
DELETE FROM public.setores;

-- PASSO 2: Inserir Setores Principais
...
-- PASSO 3: Inserir Subsetores para cada Setor
